...
- In progress — F0 Foundation completion: added append-only migrations 2–3 for canonical settings plus policy/job/cursor foundations, typed settings and policy IPC, first-paint locale/theme bootstrap, a real General Settings screen, typed routes, and a refactored Area route. Native credential storage, generic lifecycle safety, full route registry, and Windows evidence remain pending.
